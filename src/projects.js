	...
	return (
		<main className={styles.container}>
			<section className={styles.card}>
				...
				<p>
					Hearbuds allows users to find concerts in their area and
				...
				<a href="https://hearbuds-client.firebaseapp.com/">
					<img
						src="https://github.com/j-stuckey/hearbuds-client/raw/master/screenshots/desktop-dashboard.png"
						alt="hearbuds"
					/>
				</a>
				...
				<a
					href={'https://hearbuds-client.firebaseapp.com/'}
					target="_blank"
				...
				<a
					href={'https://github.com/j-stuckey/hearbuds-client'}
					target="_blank"
					className={styles.button}
				>
					Github Repo
			...
			<section className={styles.card}>
				...
				<p>
					Can't find the right words? Use Emojis instead! This app
				...
				<a
					href="https://spacedrep-client.herokuapp.com/"
					target="_blank"
				...
				<a
					href="https://github.com/j-stuckey/courtney-james-spacedRepitition-client"
					target="_blank"
					rel="noopener noreferrer"
					className={styles.button}
				>
			...
			<section className={styles.card}>
				...
				<p>
					This was my first full stack project using React/Redux and
					Node. The app allows users to search a movie database, and
					categorize movies and tv shows into lists. I created this
				...
				<a
					href="https://james-moviesurfer-client.herokuapp.com/"
					target="_blank"
					rel="noopener noreferrer"
					className={styles.button}
				>
				...
				<a
					href="https://github.com/j-stuckey/james-capstone-client"
					target="_blank"
					rel="noopener noreferrer"
					className={styles.button}
				>
